...
public class Game {
	...
	public static void main(String[] args) {
		...
		// Initialize players
		Player player=new Player(1, "Player", board, 0, -N/2, -N/2, null, null, null);
		HeuristicPlayer heuristicPlayer=new HeuristicPlayer(0, "heuristicPlayer", board, 0, N/2, N/2, null, null, null,path,2,game.round);
		heuristicPlayer.setD(2);
